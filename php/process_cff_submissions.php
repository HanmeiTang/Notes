...
$query_specific = "SELECT id, formid, data, paypal_post, ipaddr FROM  $table WHERE `id` = 630 ORDER BY id DESC";

$entries = $wpdb->get_results($query_null_clean_data);  // change condition here
